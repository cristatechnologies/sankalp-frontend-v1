        ...
        <div className="main-wrapper-card relative">
          ...
          >
            ...
            <div className="product-card-details px-[30px] pb-[30px] relative pt-2">
              {/* add to card button */}
               {catalogModeStatus !== true ? <div className="absolute w-full h-10 px-[30px] left-0 top-40 group-hover:top-[85px] transition-all duration-300 ease-in-out">
                <button
            ...
            {/* quick-access-btns */}
           {catalogModeStatus !== true ?  <div className="quick-access-btns flex flex-col space-y-2">
              <button
                className={
