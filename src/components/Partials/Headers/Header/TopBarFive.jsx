                    ...
                    categoryList.map((category, index) => (
                      <div className="relative group" key={index}>
                        <Link
                          ...
                          legacyBehavior
                        >
                          <a className="border-t-2 border-[var(--primary-color)] flex px-4 py-3 hover:bg-gray-50 text-sm min-w-max">
                            {category.name}
                          </a>
                        </Link>
                        {/* Handle children similarly */}
                      </div>
                    ))}
                </div>
              </div>
          ...
          <div className="topbar-dropdowns lg:block hidden">
            <div className="flex ltr:space-x-6 rtl:-space-x-0 items-center">
              <div className="flex space-x-6 rtl:space-x-reverse items-center relative">
                ...
                <div className="favorite relative ">
                  <Link href="/wishlist" passHref rel="noopener noreferrer">
                    <span className="cursor-pointer ">
                ...
                <div className="cart-wrapper group relative py-4">
                  <div className="cart relative cursor-pointer">
                    <Link href="/cart" passHref rel="noopener noreferrer">
                      <span className="cursor-pointer">
                        <ThinBag
